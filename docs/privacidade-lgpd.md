...
Segfy segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Segfy** | BR | Plataforma de seguros (provedor dos dados do usuário) |
| **Google Firebase (Identity Platform)** | US | Provedor de autenticação usado pelo login do Segfy |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [segfy@mcp.ai](mailto:segfy@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
